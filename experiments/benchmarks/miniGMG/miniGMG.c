...
//int MPI_threadingModelRequested = MPI_THREAD_MULTIPLE;
  ...
  if(argc==2){
    ...
    subdomains_per_rank_in_k=atoi(argv[4]);
          ...
          log2_subdomain_dim=5;//atoi(argv[1]);
    subdomains_per_rank_in_i=2;//atoi(argv[2]);
    subdomains_per_rank_in_j=2;//atoi(argv[3]);
    subdomains_per_rank_in_k=2;//atoi(argv[4]);
                  ranks_in_i=1;//atoi(argv[5]);
                  ranks_in_j=1;//atoi(argv[6]);
                  ranks_in_k=1;//atoi(argv[7]);
  }else if(argc!=1){
